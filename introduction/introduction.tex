...
\label{chap:introduction}
    ...
    \section{Background}
        ...
        In this study, a controller architecture will be designed to address this problem.

    \section{Project definition and objectives}

        \paragraph
        This project aims to design and implement a controller architecture for stabilised control of a multirotor with an unknown suspended payload.
