\FloatBarrier\section{Simulation Environment} \label{sec:simulation_environment}
    ...
    In contrast, the SITL and Gazebo simulation environment requires text-based control laws with C\texttt{++} and requires ROS nodes to interface an \gls{MPC} with PX4.
