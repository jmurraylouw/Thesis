\FloatBarrier\section{LQR} \label{sec:lqr}
        ...
        \paragraph
        \gls{LQR} is a popular optimal control technique and has been shown to be an effective swing-damping controller for multirotors with a suspended payload 
        ...
        This controller structure can be duplicated for East velocity control due the symmetry of a quadrotor.
        ...
        \begin{align}
            ...
            \bm{A}_A &= 
                \begin{bmatrix}
                    0 & -1 & 0 & 0 \\
                    0 & 0 & \frac{ m_p \cdot g}{m_Q} & \frac{c_{\theta}}{(l\cdot m_Q)} \\
                    0 & 0 & 0 & 1 \\
                    0 & 0 & \frac{ (m_p+m_Q) \cdot g}{(m_Q \cdot l) } & \frac{ -c_{\theta} \cdot (m_p+m_Q)}{(l^2 \cdot m_Q \cdot m_p)}
