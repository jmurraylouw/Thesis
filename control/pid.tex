\FloatBarrier\section{Cascaded PID control}
    ...
    \FloatBarrier\subsection{Translational controller}
        ...
        \paragraph
        The derivation of the trasfer function, $G_{V_N}(s)$, of the North velocity dynamics 
        of a multirotor with a suspened payload was derived by \cite{Slabber2020} and is described here briefly.
        ...
        \begin{align}
            ...
            \textbf{A}_{long} &= 
            \begin{bmatrix}
                0 & \frac{ c_{\theta} }{ l m_Q } & \frac{ g m_p }{ m_Q }\\[0.5em]
                0 & -\frac{ c_{\theta} (m_Q + m_p) }{ l^2 m_Q m_p } & -\frac{ g (m_Q + m_p) }{ l m_Q } \\[0.5em]
                0 & 1 & 0
            \end{bmatrix}^T, \\
            % 
            \textbf{B}_{long}& = 
        ...
        % ?? Check for consistency and for Francois wording

        \paragraph
        A payload with $m_p =$ and $l =$ is considered for the controller design.
% ?? OCntinue here
