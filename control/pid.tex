\FloatBarrier\section{Cascaded PID control} \label{sec:cascaded_pid}
    ...
    This is the default control architecture used in the PX4-Autopilot flight stack \cite{Meier2015}.
    ...
    \FloatBarrier\subsection{Angular rate controller}
        ...
        Some elements in the controller improve the practical implementation, but have a negligible effect on the design on the gains, namely:
        \begin{itemize}
