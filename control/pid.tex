\FloatBarrier\section{Cascaded PID control} \label{sec:cascaded_pid}
    ...
    % Finally the controllers will be implemented with MATLAB and Simulink\texttrademark~and are verified with practical flight data.
    ...
    \FloatBarrier\subsection{Angle controller}
        ...
        The proportional gain was designed for Honeybee by \cite{Grobler2020} for a transient response that is faster than the default ZMR250 response.
