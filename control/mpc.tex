...
% ?? Talk about design of value 0.1 in distrubance model
    ...
    \FloatBarrier\subsection{Tuning}
        ...
        \paragraph
        Hereafter, the value of $T_p = T_c$ was incrementally decreased untill a noticeable change in the controller performnace.
        ...
        Thereafter the \gls{MPC} is simulated with the same controller configuration defined in Table~ref{tbl:}.
