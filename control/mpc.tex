\FloatBarrier\section{Model Predictive Control} \label{sec:mpc}
    ...
    \paragraph
    Each \gls{MPC} implementation depends on the plant model representation \cite{Garcia1989}.
    ...
    \FloatBarrier\subsection{Algorithm implementation}
        ...
        Therefore, it can integrate with the \gls{SITL} implementation of PX4 and it can be run on an \gls{OBC} for practical implementations.
