...
% ?? remove all MV and MO
    ...
    \FloatBarrier\subsection{Receding horizon}
        ...
        \paragraph
        As stated before, an MPC considers an open-loop optimal control problem over a finite prediction horizon \cite{Mayne2000}.
        ...
        MPC is also refered to as Receding Horizon Control, because the control sequence is determined for the next prediction horizon period at every time-step.
        ...
        % Therefore the MPC determines a control sequence that would produce the optimsed trajectory of the output variable.
