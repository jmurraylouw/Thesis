...
\label{chap:control}
    ...
    \FloatBarrier\section{Implentation and results}
        ...
        \FloatBarrier\subsection{Dynamic payload}
            ...
            show that the model does not represent the simulated system for all possible values of the state and input vectors. 

            \paragraph
            This shows that 
            overfit to dynamics
            effect of controller.
            Due to the feedback nature of a controller
