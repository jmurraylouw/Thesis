...
\label{chap:control}
    ...
    \FloatBarrier\section{Cascaded PID}
        ...
        \paragraph
        This section gives an overview of the PID controller architecture and the design process used to determine the controller gains.
        PX4-Autopilot was chosen as the multirotor flight-stack because it is open-source and is widely used in industry and research.
        The default multirotor PX4 control architecture consists of multiple cascaded PID controller loops.
        This can be devided into two main categories, the inner loop attitude controllers and the outher loop translational controllers.
        Figure~\ref{fig:pid_architecture} shows a high level overview of the PX4 control architecture, excluding controller feedback. 
        
        \input{control/diagrams/pid_architecture.tex}
        \input{control/diagrams/anton_diagram.tex}
        
        \paragraph
        The attitude controls, consisting of the angular rate and angle controlelrs, deal with the fastest dyamics and therefore run at the highest frequency.
        The ou


        \FloatBarrier\section{PX4 control architecture}

            Diagram of cascaded loop

        \FloatBarrier\section{Attitude controllers}

            Designed with rootlocus. explain. cite anton and reghard.
            Gains used from reghard.

        \FloatBarrier\section{Translational controllers}
