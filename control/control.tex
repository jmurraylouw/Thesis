...
\label{chap:control}
    ...
    \FloatBarrier\section{Cascaded PID}
        ...
        \FloatBarrier\subsection{Translational controller}
            ...
            A diagram of the PX4 velocity controller is shown in Figure~\ref{fig:velocity_controller}.
            ...
            Therefore the velocity controller gains are designed for a slower transient reponse which results in smaller payload swing angles.
