...
\label{chap:control}
    ...
    \FloatBarrier\section{Cascaded PID}
        ...
        \FloatBarrier\subsection{Translational controller}
            ...
            \begin{figure}
                ...
                \centering  
                \input{control/plots/rootlocus_open_loop.tex} % subfigure
                \input{control/plots/rootlocus_closed_loop.tex} % subfigure
                \caption{Root locus plots of the North velocity controller}
                \label{fig:rootlocus_subfigs}  
            \end{figure}

            \input{control/plots/pid_tuning_plot.tex}

            Figure~\ref{fig:pid_tuning_plot} shows ...
    ...
    \FloatBarrier\section{LQR} \label{sec:lqr}
        ...
        \paragraph
        LQR is a well-kown technique, ...
        % LQR is \cite{get cite}
        An LQR for North velocity control is presented in this section. 
        This controller structure can be duplicated for East veloicty control.
        Full-state feedback. Effect of EKF not included.
