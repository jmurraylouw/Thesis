...
\label{chap:control}
    ...
    \FloatBarrier\section{Implentation and results}
        ...
        \FloatBarrier\subsection{Different system parameters}
            ...
            \paragraph
            However, the control architectures are not all very adaptable to variation of other system parameters.
            ...
            Hence, changing the mass of the multirotor by adding or removing an accesory is detrimental to the accuracy of plant model and therefore affects the LQR performance.
            In contrast, the data-driven system identification of the MPC plant model does not rely on such modelling assumptions.
            Therefore a change in the multirotor mass does affect the MPC implementation.

            \paragraph
            Simulations were performed with an altered multirotor mass.
            Figure~\ref{fig:mq_changed} shows the resulting velocity step responses of the PID, MPC and LQR.


            \paragraph
            Unfair
            LQR is robust for other changes.
            But does show the advantage
