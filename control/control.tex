...
\label{chap:control}
    ...
    \FloatBarrier\section{Cascaded PID}
        ...
        \FloatBarrier\section{PX4 control architecture}
            ...
            \paragraph
            Figure~\ref{fig:pid_architecture} shows a high level overview of the PX4 control architecture which does not show state feedback. 
            The attitude controllers, consisting of the angular rate and angle controlelrs, deal with the fastest dyamics and therefore run at the highest frequency.
            The angular rate controller
            The ou
