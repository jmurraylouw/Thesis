...
\label{sec:control_implementation}
    ...
    \FloatBarrier\subsection{Simple suspended payload} \label{sec:simple_payload_control}
        ...
        Figure~\ref{fig:compare_control_vel} shows the velocity step responces of the MPC, \gls{LQR} and \gls{PID} controllers for a multirotor with a suspended payload.
