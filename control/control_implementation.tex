...
\label{sec:control_implementation}
    ...
    \FloatBarrier\subsection{Simple suspended payload} \label{sec:simple_payload_control}
        ...
        Both the \gls{MPC} and \gls{LQR} damp the payload angle well and the oscillations cease after only two or three swings.
        ...
        However, this is also highly dependant on the weightings used in optimisation problem of both controllers.
