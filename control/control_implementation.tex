...
\label{sec:control_implementation}
    ...
    \FloatBarrier\subsection{Simple suspended payload} \label{sec:simple_payload_control}
        ...
        In this case, the \gls{MPC} response results in a slightly smaller initial swing angle, however, this is dependant on the specific tuning of each controller.
