\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        ...
        \addplot+[mark = none, style = solid, ultra thick] 
        table[x = train_time, y = percentage_error, col sep = comma] 
        {results/csv/cable_length_vs_train_time_Prac_2021-08-12_02_manual_x_vel_steps_4mps.csv_10_1.csv};
        \addlegendentry{wind speed $\approx~$\SI{4}{\metre/\second}}

        \end{axis}
    \end{tikzpicture} 
    
    \caption{Influence of wind on cable length estimation error as a function of length of training data
