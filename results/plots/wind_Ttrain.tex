\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        ...
        \addlegendentry{2.0 m/s winds}

        \addplot+[mark = none, style = solid, ultra thick] 
        table[x = T_train, y expr = {\thisrow{NMAE_mean}*100}, col sep = comma] 
        {results/csv/NMAE_vs_Ntrain_Prac_2021-08-12_02_manual_x_vel_steps_4mps.csv_dmd_angle.csv};
        \addlegendentry{4.0 m/s winds}

        \end{axis}
    \end{tikzpicture} 
    
    \caption{Effect of wind on DMD prediction errors for different lengths of practical training data
