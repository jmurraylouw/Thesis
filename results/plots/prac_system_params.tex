\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        ...
        \addlegendentry{$m =$~\SI{0.2}{\kilo\gram}, $l = $~\SI{0.5}{\metre}}
    ...
    \caption{\gls{DMD} prediction error as a function of training data length for different payload parameters}
