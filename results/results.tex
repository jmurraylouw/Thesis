...
\label{chap:results}
    ...
    but this disturbance was not considered in simulation.
    ...
    The effect of different system configurations and wind conditions on the performance of these techniques will be investiagted.
    ...
    Finally, it will be determined whether the proposed system identification with control architectures are feasable for practical flights.
    ...
    \FloatBarrier\section{Methodology}
        ...
        \begin{enumerate}
            ...
            \item Download data log from the multirotor
        ...
        In simulation, the payload cable is attached to the exact \gls{CoM} of the multirotor.
    ...
    \FloatBarrier\section{Data-driven system identification with practical data}
        ...
        \paragraph
        In Chapter~\ref{chap:system_id} it was shown that \gls{DMDc} and \gls{HAVOKc} 
        ...
        \FloatBarrier\subsection{Wind disturbance} \label{sec:length_train_data_prac}
            ...
            This disturbance consists of a randomly fluctuating force
            applied to the vehicle, cable and payload.
            ...
            The mean force applied to the multirotor by the wind
            affects the mean offset in acceleration setpoint data 
