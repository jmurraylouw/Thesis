...
\label{chap:results}
    ...
    \FloatBarrier\section{Data-driven system identification with practical data}
        ...
        \FloatBarrier\subsection{Extended dimensions}
            ...
            Figure~\ref{fig:} DMD predictions

            \input{results/plots/prac_pediction_xy_theta_x.tex}
            \input{results/plots/prac_pediction_xy_theta_y.tex}
            \input{results/plots/prac_pediction_xy_vel_x.tex}
            \input{results/plots/prac_pediction_xy_vel_y.tex}

            \begin{itemize}
                \item plot error vs q
                \item convert to subfigs
                \item correct y label
                \item dashed prediction
            \end{itemize}
