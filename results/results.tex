...
\chapter{Practical implementation and results} \label{chap:results}
    ...
    \FloatBarrier\section{Parameter estimation with practical data}
        ...
        \paragraph
        In Section~\ref{sec:param_estimation}, a cable length parameter estimation technique was performed with simulation data and the resulting white-box models provided reasonably accurate representations of the simulated multirotor-payload dynamics.
        ...
        \FloatBarrier\subsection{Dynamic payload cable length estimation} \label{sec:dynamic_payload_prac}
            ...
            Therefore the effect of the superimposed higher frequency oscillations become less prominent and the system dynamics approximate a single pendulum more closely.
    ...
    \FloatBarrier\section{Hardware-in-the-Loop simulations}
        ...
        \FloatBarrier\subsection{Effect of sample time on computational requirements}    
            ...
            However, an \gls{MPC} node with $T_s =$~\SI{30}{\milli\second} provides stable control of the multirotor-payload system.
    ...
    \FloatBarrier\section{Summary}
        ...
        It also showed that the control architecture can be implemented on the hardware of an actual multirotor to successfully apply swing-damping control of the multirotor-payload system.
