...
\chapter{Practical implementation and results} \label{chap:results}
    ...
    \FloatBarrier\section{Parameter estimation with practical data}
        ...
        \FloatBarrier\subsection{Simple payload cable length estimation}
            ...
            \paragraph 
            Figure~\ref{fig:cable_length_vs_train_time} shows the \gls{PE} of the cable length estimation for practical flight data with different payload masses and cable lengths using practical fligth data.
