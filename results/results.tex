...
\label{chap:results}
    ...
    \FloatBarrier\section{Data-driven system identification with practical data}
        ...
        \FloatBarrier\subsection{Wind disturbance} \label{sec:length_train_data_prac}
            ...
            \paragraph
            Figure~\ref{fig:havok_vs_dmd_Ttrain_2mps} compares the prediction errors of \gls{DMDc} and \gls{HAVOK} models.
            ...
            The \gls{DMDc} implementation is therefore prefered over \gls{HAVOK} due to a lower computational complexity.
