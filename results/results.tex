...
\label{chap:results}
    ...
    \FloatBarrier\section{Methodology}
        ...
        The same methodology is followed for both simulated and practical flights.
    ...
    \FloatBarrier\section{Parameter estimation with practical data}
        ...
        \FloatBarrier\subsection{Simple payload cable length estimation}
            ...
            However, there are not enough flights to identify a trend conclusively.

            \input{results/plots/cable_length_vs_train_time_wind.tex}

            Note that the estimation \gls{PE} converges for flights with different wind speeds.
            Therefore it appears that a dominantoscillation frequency
