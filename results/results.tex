...
\chapter{Practical implementation and results} \label{chap:results}
    ...
    \FloatBarrier\section{HITL}
        ...
        The \gls{OBC} receives state feedback and sends control signals via a \gls{UART} connection to the \gls{FC}.
        ...
        \FloatBarrier\subsection{Velocity step response}    
            ...
            It is clear from this plot that the \gls{MPC} node running on the \gls{OBC} provides stable control of the quadrotor payload system and damps the velocity oscillations well.
