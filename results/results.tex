...
\chapter{Practical implementation and results} \label{chap:results}
    ...
    \FloatBarrier\section{HITL}
        ...
        \FloatBarrier\subsection{Effect of hyperparameters on computational requirements}    
            ...
            The \scaleobj{0.8}{\%}CPU value represents the average percentage of \gls{CPU} time used by the \gls{MPC} node running on the companion computer.
            ...
            Figure~\ref{fig:CPU_vs_q} shows that the companion computer runs the \gls{MPC} node with $q = 50$ and $T_s =$~\SI{0.03}{\second} at \scaleobj{0.8}{\%}CPU~$= 82.8\%$.
            ...
            However, for $q = 70$ the \gls{MPC} node used \scaleobj{0.8}{\%}CPU~$= 98.7\%$ and the optimisation problem could not be solved fast enough for stable control.
            ...
            The \scaleobj{0.8}{\%}RAM value represents the maximum percentage of \gls{RAM} space used by the \gls{MPC} node while running on the companion computer.
        ...
        \FloatBarrier\subsection{Effect of sample time on computational requirements}    
            ...
            \paragraph
            A \gls{MPC} node with $T_s =$~\SI{40}{\milli\second} runs with a low \scaleobj{0.8}{\%}CPU, however it also results in unstable control.
