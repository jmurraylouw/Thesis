...
\label{chap:results}
    ...
    \FloatBarrier\section{Parameter estimation with practical data}
        ...
        \FloatBarrier\subsection{Simple payload cable length estimation}
            ...
            This large difference is expected at such large swing angles, because the model was a linearised with the small angle approximation (as discussed in Chapter~\ref{chap:modelling}).
        ...
        \FloatBarrier\subsection{Dynamic payload cable length estimation}
            ...
            Figure~\ref{fig:prediction_double_pend_white_prac} shows the measured payload angle for this flight.
            The estimated cable length is \SI{1.03}{\metre}, which is used in the white-box model.
            The resulting payload angle prediction is also plotted in Figure~\ref{fig:prediction_double_pend_white_prac}.

            \input{results/plots/prediction_double_pend_white_prac.tex}
