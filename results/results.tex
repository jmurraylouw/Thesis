...
\label{chap:results}
    ...
    \FloatBarrier\section{HITL}
        ...
        The controller frequency of \SI{33.33}{\hertz} appears to be fast enough to control the quadrotor-payload dynamics.
        The QP problem can also be solved fast enough with this sample time on the companion computer.
