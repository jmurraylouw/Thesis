...
\chapter{Experimental design} \label{chap:exp_design}
    ...
    \paragraph
    As discussed in Chapter~\ref{chap:chap:lit_study}, experimental data is a valuable part of any study involving multirotors control.
    ...
    \FloatBarrier\section{Hardware components}
        ...
        \paragraph
        The hardware involved in this work include a multirotor vehicle, a custom-made payload state sensor, and an \gls{OBC}.
        ...
        \FloatBarrier\subsection{Multirotor}
            ...
            \begin{figure}[ht]
                \centering
                \includegraphics[width=0.6\linewidth]{exp_design/fig/honeybee}
            ...
            Note that the mass and inertial parameters include the \gls{OBC} and payload state sensor.
    ...
    \FloatBarrier\section{Software Toolchain}
        ...
        \FloatBarrier\subsection{MATLAB/Simulink}
