...
\chapter{Experimental design} \label{chap:exp_design}
    ...
    This chapter will provide an overview of the hardware, software, HITL simulations, and practical methodology used in this work.
    ...
    \FloatBarrier\section{Software Toolchain}
        ...
        \subsection{Robot Operating System}
            ...
            This data is published by MAVROS to various ROS topics.
            State estimate data is received by the MPC node by subscribing to the appropriate MAVROS topic.
            After the MPC node calculates the next controller decision, it publishes the controller setpoint data to a MAVROS topic.
    ...
    \FloatBarrier\section{Hardware-in-the-Loop simulations} \label{sec:exp_design_hitl}
        ...
        The \gls{OBC} runs the MPC and MAVROS nodes which send and receive MAVLink messages over a serial port connection to the \gls{FC}.
