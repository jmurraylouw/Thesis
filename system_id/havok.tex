...
\label{sec:havok}
    ...
    Here, the subscript of $\bm{A}_H$ and $\bm{B}_H$ is used to differentiate these matrices from $\bm{A}$ and $\bm{B}$ used in \gls{DMDc}.
    % 
    \paragraph
    ...
    % \paragraph
    % ?? High level comparison of DMDc and HAVOKc
