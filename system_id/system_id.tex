...
\label{chap:system_id}
    ...
    will be applied to simulation data of the mulitrotor and payload system.
    ...
    \section{Conclusion}
        ...
        This proves to be promising for practical implementation with a \gls{MPC} on a mulitrotor companion computer.
        ...
        % \gls{DMDc} and \gls{HAVOK} work very similarly with single pend.
