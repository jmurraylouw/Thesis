...
\section{Implementation and results}
    ...
    \subsection{Choice of payload variable in the state vector}
        ...
        \input{system_id/plots/MAE_vs_train_SITL_angular_rate}
    ...
    \subsection{Noise}
        ...
        Figure~\ref{fig:paylbest hyperparameters.oad_noise} shows the noisy payload angle measurement for a practical pendulum test while the quadrotor is held stationary.
        ...
        % \input{system_id/plots/SITL_MAE_vs_train_noise.tex}
    ...
    \subsection{Size of training data}
        ...
        % \input{system_id/plots/MAE_vs_train_Simulink_diff2.tex}
