\section{White-box and black-box techniques}
    ...
    \subsection{White-box techniques}
        ...
        \begin{itemize}
            ...
            \item The link is attached to the \gls{CoM} of the quadrotor.
        \end{itemize}
        ...
        In this configuration it was shown that a \gls{LQR} controller successfully controls a quadrotor while minimising payload swing angles.
