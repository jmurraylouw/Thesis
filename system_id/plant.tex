\section{Plant considered for system identification} \label{sec:plant_considered}
    ...
    Because of the symmetry of the multirotor, this controller can then duplicated for East velocity control.
    ...
    \begin{equation}
        ...
        \end{bmatrix} .
    \end{equation}
    For swing damping control, the controllers require state feedback from both the multirotor and payload,
    ...
    % but the controllers apply an augmented state vector that will be discussed in Chapter~\ref{chap:control}.
    ...
    In the following sections, simulations of the full multirotor and payload system will be performed
