\section{Plant considered for system identification} \label{sec:plant_considered}
    ...
    % As discussed in Section~\ref{sec:linear_model}, the payload minimally effects the quadrotor attitude because it is attached near the \gls{CoM} of the vehicle.
