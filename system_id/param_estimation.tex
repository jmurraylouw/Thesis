\section{Parameter estimation} \label{sec:param_estimation}
    ...
    This approach was successfully used by \cite{Erasmus2020} and \cite{Slabber2020} 
...
\subsection{Cable length estimation} \label{sec:length_estimation}
    ...
    As documented by \cite{Erasmus2020} and \cite{Slabber2020}, an error of this magnitude is acceptably small and still results in effective control with a \gls{LQR}.
    It was also shown by \cite{Erasmus2020} and \cite{Slabber2020} that this estimation method is effective for a range of different payloads in simulation.
