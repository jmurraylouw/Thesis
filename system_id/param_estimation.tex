\section{Parameter estimation} \label{sec:param_estimation}
    ...
    The identified model is used to design a LQR controller and
    ...
    to design a LQR controller and implement swing damping control 
...
\subsection{Cable length estimation} \label{sec:length_estimation}
    ...
    and still results in effective control with a LQR.
