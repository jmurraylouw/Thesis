...
\subsection{White-box model}
    ...
    \paragraph
    It is assumed that the coefficient of friction, $c$, does not change for different payload, therefore this parameter can be determine experimentally and will known before a flight.
    Furthermore, it is assumed that $m_Q$ is known.
    The payload parameters, 
    $m_p$ and $l$, are unknown before a flight. 
