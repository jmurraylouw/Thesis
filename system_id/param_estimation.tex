...
\subsection{Payload mass estimation}
    ...
    The method will clearly be inaccurate if a unknown mass is added to the mulitrotor 
...
\subsection{Cable length estimation} \label{sec:length_estimation}
    ...
    after a position step by the mulitrotor.
    ...
    to minimise the effect of the transient response and the mulitrotor controllers 
