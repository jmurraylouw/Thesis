\section{Parameter estimation} \label{sec:param_estimation}
    ...
    \paragraph
    The purpose of parameter estimation is to determine unknown parameter values 
    required by a predetermined, white-box model.
    The identified model is used to design a LQR controller,
    therefore the model needs to be a linear, continuos time, state-space form.
    ...
    These methods were also used by \cite{Erasmus2020} and \cite{Slabber2020} 
