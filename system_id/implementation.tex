\section{Implementation and results}
    ...
    \subsection{System parameters}
        ...
        \begin{equation}
            0.025 \leq l \leq \SI{2}{\metre} .
        \end{equation}
        A cable length shorter than \SI{0.025}{\metre} is quite impractical and may rather be attached as a rigid payload.
        ...
        Plot MAE vs l
        Plot MAE vs m
        See if you can rather plot MAE vs l, with contours of m
