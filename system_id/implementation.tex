\section{Implementation and results}
    ...
    \subsection{Dynamic payload} \label{sec:dynamic_payload}
        ...
        The DMDc and HAVOK models can still approximate the dynamics without measuring this state variable
        because of the delay embedding and Taken's Embedding Theorem \cite{Kamb2020}.
