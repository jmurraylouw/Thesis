\section{Implementation and results}
    ...
    \subsection{Noise}
        ...
        Figure~\ref{fig} shows the North acceleration setpoint during the training period.
        ...
        The moving window mean is then reapplied to the control signal of the MPC 
