\section{Implementation and results}
    ...
    \subsection{Dynamic payload}
        ...
        The data-driven techniques result in a discrete state space model 
        which is used for optimisation over a prediction horizon in a MPC. 
        Even though the models cannot easily be compared, 
        the performance of controllers using these models can be compared.
        This will be investigated in % Chapter~\ref{chap:}

        \paragraph{}
        Since the a priori white-box model is based on a single pendulum model, 
        the resulting state predictions are significantly different from the actual dynamics.
