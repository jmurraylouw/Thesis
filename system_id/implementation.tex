\section{Implementation and results}
    ...
    \subsection{Methodology} \label{sec:sys_id_methodology}
        ...
        Therefore the data seen by the system identification techniques 
        ...
        since they do not show high frequency oscillations as seen in the North velocity.
    ...
    \subsection{Error metric}
        ...
        \paragraph        
        It is common practice is to select a model for an \gls{MPC} based on k-step-ahead prediction errors \cite{Zhao2014}.
        ...
        However, for the case of a multirotor with a payload, it is assumed that variance error 
        ...
        This not only reduces overfitting, but also ensures that the \gls{MPC} optimisation problem 
        is not too computational intensive for the available hardware.
        ...
        In order to have an \gls{MPC} that can control the plant during the different stages of a flight, 
    ...
    \subsection{Length of training data} \label{sec:sys_id_length_of_data}
        ...
        it is obvious that the accuracy of a model depends 
