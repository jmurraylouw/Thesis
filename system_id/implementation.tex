\section{Implementation and results}
    ...
    \subsection{Methodology} \label{sec:sys_id_methodology}
        ...
        and the PX4 flight stack applies an EKF for state estimation.
        Therefore the the data seen by the system identification techniques 
        include the same EKF filtering as practical flight data.
        ...
        A ROS node is used to read and log the payload angle measurement from Gazebo 
        and a different ROS node is used to send velocity setpoints to PX4 
    ...
    \subsection{Error metric}
        ...
        \paragraph
        MRAE is also popular metric for comparing predictions models used with a \gls{MPC} \cite{Kaiser2018b},
        ...
        However, an in-sample forecast is a na{\"i}ve prediction for a one-step-ahead prediction, 
