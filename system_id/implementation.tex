\section{Implementation and results}
    ...
    \subsection{Sample time}
        ...
        Due to the computational complexity of an \gls{MPC}, the optimiser will struggle to run at \SI{50}{\hertz} on a companion computer on a quadrotor.
        ...
        because it provides a good balance between being fast enough for the quadrotor dynamics and slow enough for a practical \gls{MPC} implementation.
    ...
    \subsection{Noise} \label{sec:noise}
        ...
        On the practical quadrotor the \gls{IMU}, barometer, magnetometer and \gls{GPS} sensors experience measurement noise.
        ...
        \paragraph
        The potentiometer and \gls{ADC} which measure the payload angle on the quadrotor also has experience measurement noise.
        ...
        The noisy signals from both the quadrotor \gls{EKF} and payload swing angle are smoothed 
    ...
    \subsection{Dynamic payload} \label{sec:dynamic_payload}
        ...
        % However if a mass is rigidly attached to the vehicle, the effective quadrotor mass is changed and the \gls{RLS} payload mass estimation is no longer accurate.
