...
\paragraph
A parameter estimator and \gls{LQR} is used as a baseline control architecture.
...
The baseline performance degraded significantly with a changed multirotor mass because this parameter was not considered as an unknown.
