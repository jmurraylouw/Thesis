...
\FloatBarrier\section{Model verification} \label{sec:model_verification}
    ...
    Firstly, a velocity step response was performed in a practical flight with a quadrotor to verify the quadrotor model without a payload.
    The practical quadrotor will be described in Chapter~\ref{chap:exp_design}.
    This flight was performed on a day with minimal wind to try exclude the effect of wind disturbances in the comparison.
    ...
    In this figure the velocity response dot not correlate as well as they do in the experiment without a payload.
