...
\FloatBarrier\section{Rotations}
    ...
    \FloatBarrier\subsection{Quaternions}
        ...
        \begin{equation}
            \bm{q}(\Theta, \Phi, \Psi) = 
            \left[\begin{array}{c}
                \phantom{-}\cos{\frac{\Phi}{2}} \cos{\frac{\Theta}{2}}  \cos{\frac{\Psi}{2}}    ~~+~~\sin{\frac{\Phi}{2}}   \sin{\frac{\Theta}{2}}  \sin{\frac{\Psi}{2}} \\
                          -\cos{\frac{\Phi}{2}} \sin{\frac{\Theta}{2}}  \sin{\frac{\Psi}{2}}    ~~+~~\cos{\frac{\Theta}{2}} \cos{\frac{\Psi}{2}}    \sin{\frac{\Phi}{2}} \\
                \phantom{-}\cos{\frac{\Phi}{2}} \cos{\frac{\Psi}{2}}    \sin{\frac{\Theta}{2}}  ~~+~~\sin{\frac{\Phi}{2}}   \cos{\frac{\Psi}{2}}    \sin{\frac{\Psi}{2}} \\
                \phantom{-}\cos{\frac{\Phi}{2}} \cos{\frac{\Theta}{2}}  \sin{\frac{\Psi}{2}}    ~~-~~\sin{\frac{\Phi}{2}}   \cos{\frac{\Psi}{2}}    \sin{\frac{\Theta}{2}}
            \end{array}\right]
        \end{equation}
