...
\FloatBarrier\section{Suspended payload model} \label{sec:payload_model}
    ...
    \FloatBarrier\subsection{Payload forces acting on the quadrotor}
        ...
        This simulation model will be verified with practical data in the following section. 

\FloatBarrier\section{Model verification} \label{sec:model_verification}

    \paragraph
    To verify whether the simulation model derived in previous sections is an accurate representation of the real-world dynamics, the simulation data is verified against practical data.
    ...
    This mathematical model derived in this chapter will therefore be used for further simulations in subsequent chapters.
