...
\FloatBarrier\section{Quadrotor model}
    ...
    \begin{table}[!htbp]
        ...
        \begin{tabularx}{0.3\linewidth}{@{}ll@{}}
            \toprule
    ...
    \begin{align}
        ...
        \end{bmatrix}^T ,
    \end{align}
    are the forces and moments, respectively, acting on the quadrotor, with respect to the body frame. The linear and angular velocity of the quadrotor are given by
    \begin{align}
        \bm{V_\mathcal{B}} & = 
        \begin{bmatrix}
        ...
        \end{bmatrix}^T.
    \end{align}
    The quadrotor mass is  denoted by $m_Q$ and its inertia tensor is given by
    \begin{equation} \label{eq:inertia}
        ...
        \end{bmatrix}.
    \end{equation}
    The inertia tensor can be simplified as shown in Equation (\ref{eq:inertia}) due to the symmetry of the quadrotor in the XZ- and YZ-plane. 
