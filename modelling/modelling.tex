...
\FloatBarrier\section{Forces and moments}
    ...
    This force and moment can be represented in terms of virtual actuators as,
    \begin{equation}
        \bm{F}_{\mathcal{B}}^T = 
        \begin{bmatrix}
            0\\
        ...
        \end{bmatrix} ,
    \end{equation}
    where $d \delta_T$, $d \delta_A$, $d \delta_E$, and $d \delta_R$, represent the virtual aileron, elevator, and rudder actuators.
    ...
    \begin{equation} \label{eq:mixing_matrix}
        ...
        \end{bmatrix} ,
    \end{equation}
    where $\bm{T} = [T_1~~T_2~~T_3~~T_4]^T$ is a vector of thrust forces produced by the four individual rotors.
    ...
    These forces and moments will be discussed in the section below.
