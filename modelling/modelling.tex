...
A simulation environnement will use this model to simulate the multirotor-payload system in subsequent chapters.

\paragraph
The chapter starts by defining the coordinate frames and rotation representations used in this work.
After a discussion of the different forces and moments acting on this vehicle described, 
...
Finally, practical flight data will verify the mathematical models used in simulation.
...
\FloatBarrier\section{Coordinate frames}
    ...
    Figure~\ref{fig:coord_frames} shows the quadrotor schematic and two coordinate frames that are used to describe this system.
...
\FloatBarrier\section{Rotations}
    ...
    The attitude is defined in terms of Euler angles or quaternions in this work, which is described below.
    ...
    \FloatBarrier\subsection{Quaternions}
        ...
        These equations are applied in subsequent chapters.
