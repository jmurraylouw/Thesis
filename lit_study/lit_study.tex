...
\section{Control of multirotors with suspended payloads}
    ...
    % Unknown payloads
    % what is unknown
    As observed by \citet{Hua2021}, most of the reported controllers designed for multirotors with suspended payloads are based on accurate models where the model uncertainties are not considered in their studies.
    ...
    In Table~\ref{tbl:literature}, the column ``Plant model'' refers to the plant model representing the dynamics which include the suspended payload.
