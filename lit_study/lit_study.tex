...
\section{Control of multirotors with suspended payloads}
    ...
    \subsection{Active vibration damping controllers}
        ...
        \begin{figure}[ht]
            \centering
            \includegraphics[width=0.5\linewidth]{lit_study/fig/motion_capture}
        ...
        \paragraph
        As observed by \citet{Hua2021}, most of the reported controllers are designed based on accurate models and model uncertainties are not considered in the studies.
        
        The column ``Parameter uncertainty'' does not consider uncertainty due to modelling errors as a result of a priori linearisation and discretisation.
        Here uncertainty is considered as a result of the unknown physical properties or dynamics of a system prior to flight.
        
        In some studies, multiple controllers are applied to different parts of the control problem where the plant models considered by some controllers are non-linear, and others are linear \cite{Martinez-Vasquez2020}.
        In Table~\ref{tbl:lit}, the column ``Plant model'' refers to the plant model representing the dynamics which include the suspended payload.
