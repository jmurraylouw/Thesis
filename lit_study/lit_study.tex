...
\section{Control of multirotors with suspended payloads}
    ...
    \FloatBarrier\section{Review of swing damping control studies} \label{sec:review_swing_damping}
        ...
        However, some practical implementation apply controllers which do not depend on a plant model and show promising results \cite{Muthusamy2021a, Hua2021, Faust2014}.
        ...
        In these experiments, motion capture systems like Vicon \cite{Muthusamy2021a, Hua2021, Faust2014, Zurn2016, Son2019, Son2018}, Qualisys \cite{Liang2021} or Optitrack \cite{Mosco-Luciano2020} provide high accuracy state feedback data at rates of \SI{100}{\hertz} or more.
        ...
        This approach is useful for complicated working conditions where the model dynamics cannot be known prior to flight \cite{Hua2021}.
...
\section{Multirotor and suspended payload systems with unknown dynamics}
    ...
    % Robust methods that absorb oscillations, but no optimal control
