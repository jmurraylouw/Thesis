...
\section{Control of a multirotor with a suspended payload}
    ...
    \subsection{Trajectory generation}
        ...
        \paragraph
        Slabber et al. \cite{Slabber2020} applied a notch filter to reduce the suspended payload oscillation for velocity control of a multirotor in simulation.
        To improve robustness against parameter uncertainty, the frequency band of the notch filter can be increased at the expense of oscillation attenuation.
        Slabber et al. \cite{Slabber2020} showed in simulation that a notch filter attenuated the payload oscillations to near swing free motion for cable length estimation errors of up to 20\%.
