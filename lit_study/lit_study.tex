...
\section{Unknown suspended payloads}
    ...
    \paragraph
    Figure~\ref{fig:real_suspended_payload_example} shows an example of a practical use case of a mulitrotor with a suspended payload.
    Items are placed in a water proof bag and transported by the mulitrotor to a place of need.
    Note that the mulitrotor does not know the dynamics of the payload before flight, 
