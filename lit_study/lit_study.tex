...
\section{Payload transportation with multirotors}
    ...
    \subsection{Cable-suspended payloads}
        ...
        Kotaru et al. \cite{Kotaru2017} considered a suspended payload system with an elastic cable modelled as a spring-damper system.
        Tang et al. \cite{Tang2015a} modelled the multirotor-payload system with a hybrid dynamical model to consider aggressive manoeuvres where the cable transitions from taut to slack.
...
\section{Control of a multirotor with a suspended payload}
    ...
    \subsection{Trajectory generation}
        ...
        \paragraph
        Ichikawa et al. \cite{Ichikawa2018a} compared different input shaping techniques for velocity control of a quadrotor with a suspended payload in simulations.
        ...
        \paragraph
        Slabber et al. \cite{Slabber2020} applied a notch filter to reduce the cable-suspended payload oscillation for velocity control of a multirotor in simulation.
        Slabber et al. considered a system with an unknown payload mass and cable length, estimated with \gls{RLS} and \gls{FFT} parameter estimators respectively.
        The natural frequency of the multirotor-payload system was then calculated based on these estimates.
        ...
        \paragraph 
        Several other open-loop methods have been successfully applied for effective suspended payload transportation.
        \cite{Zeng2019} and \cite{Tang2015b} applied differential flatness based trajectory planning methods for multirotors in obstacle-filled environments.
        ...
        Xian et al. \cite{Xian2020} proposed an efficient online trajectory planning method without iterative optimizations.
        \cite{Xian2020} also verified the swing-reduction control performance with real-time experimental results.

        % switch to natbib to use citeauthor.

        
        reinforcement learning

        \paragraph
        Other proposed trajectory generation methods include dynamic programming \cite{??}, 
    ...
    \subsection{Active vibration damping controllers}
        ...
        \cite{Hua2021} develops a non-linear control strategy embedded with \gls{RL} for position control and simueltaneous swing supression.
