...
\section{Payload transportation with multirotors}
    ...
    \subsection{Cable-suspended payloads}
        ...
        Furthermore, the control of a group of multirotors transporting a single suspended payload have also been considered in various studies \cite{Lee2015} \cite{Sanalitro2020} \cite{Klausen2014} \cite{Goodarzi2015}.
