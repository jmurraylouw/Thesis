...
\section{Control of multirotors with suspended payloads}
    ...
    \FloatBarrier\subsection{Swing damping controllers}
        ...
        The physical parameters of the quadrotor, cable, and payload were assumed to be exactly known and the controller was tested with only one payload.
    ...
    \FloatBarrier\section{Review of swing damping control studies} \label{sec:review_swing_damping}
        ...
        It is also interesting to note that the publication dates of most of these studies are quite recent.
...
\section{Multirotor and suspended payload systems with unknown dynamics}
    ...
    \paragraph
    A \gls{ADRC} was proposed by \citet{Wang2020} for the control of a multirotor with an unknown suspended payload.
